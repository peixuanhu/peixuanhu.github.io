...
1. **IBM的基因**。主要客户群基本上是政府部门、军方、银行、大企业和科研院所。IBM都是将计算机和服务绑在一起卖。
...
从开始做计算机起，IBM基本上遵循**性能优先于价格**和**集中式服务**的原则。高性能、支持多用户的主机一直是IBM硬件制造的重点，直到20世纪90年代才略有转变。IBM的许多大型机，成为计算机系统结构设计的经典之作。
